...
import { nextWeek, prevWeek } from '../../slices/calendarSlice';
  ...
  return (
    ...
    >
      <div className="d-flex flex-row align-items-center justify-content-evenly w-50">
        <button className="btn btn-outline-primary" onClick={() => dispatch(prevWeek())}>
          {'<-'}
        </button>
        <p
        ...
        <button className="btn btn-outline-primary" onClick={() => dispatch(nextWeek())}>
          {'->'}
        </button>
      </div>
